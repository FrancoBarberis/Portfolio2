  ...
  return (
    <section className="projects" id="projects">
      ...
      <div className="projects-list">
        <ProjectCard title="Wallpaper Provider" description="Portal que obtiene wallpapers de la API de Pexels, los muestra y permite su descarga en varios formatos según se necesite (4:3, 2:3, 1:1)" imageUrl={WallpaperProviderIMG} link="https://wallpaper-provider-m2g1yreq5-francobarberis-projects.vercel.app"></ProjectCard>
